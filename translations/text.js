 ...
 * @typedef {DefaultLocale | "en" | "ua"} Locale
 */

/** @type {Readonly<Record<Locale, string>>} */
export const languageMap = {
  "en": "English (not translated)",
  "ua": "Український (не перекладено)",
  "ru": "Русский",
};
...
export const titleMap = {
  ...
  "ua": "Порт оригінальної трилогії ігор STALKER на UE5",
...
export const headDescriptionMap = {
  ...
  "ua": "Це проект з перенесення оригінальної серії ігор S.T.A.L.K.E.R. на двигун Unreal Engine 5. Він має на меті відтворити постапокаліптичну атмосферу та геймплейний світ, які є характерними для серії S.T.A.L.K.E.R., з використанням передових технологій Unreal Engine 5.",
...
export const footerTextMap = {
  ...
  "ua": { utmSource: "s2ue", text: "Працює на" },
...
export const feedbackLinkMap = {
  ...
  "ua": "Запитання? Залишіть нам відгук →",
...
export const editTextMap = {
  ...
  "ua": "Редагувати цю сторінку на GitHub →",
