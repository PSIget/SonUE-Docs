  ...
  return (
    <div className="relative w-full group">
      <button
        onClick={onClick}
        className={cn(
          "flex justify-center lg:min-w-[120px] w-full text-base font-medium px-12 py-3 no-underline md:max-w-none rounded-lg md:leading-6 transition-all duration-300 whitespace-nowrap hover:opacity-80",
