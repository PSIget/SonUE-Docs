...
Мы используем [Shiki](https://shiki.matsu.io) для подсветки синтаксиса на этапе сборки.
Он очень надежный и эффективный. Например, добавление следующего кода в ваш файл Markdown:
