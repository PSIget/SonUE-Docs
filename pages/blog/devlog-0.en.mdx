...
<Authors date="2022-12-28" by="by:">
  <Author name="Red Panda" link="https://test.com/psi" />
...
Replace the values `3` with `2`. Speaker1: This will improve performance. Additionally, you can disable anti-aliasing (if your eyes are not sensitive to jagged edges). To do this, change `sg.AntiAliasingQuality=3` to `sg.AntiAliasingQuality=0`.
